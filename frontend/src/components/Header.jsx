    ...
    <div className='flex flex-col md:flex-row flex-wrap bg-[var(--color-primary)] rounded-lg px-6 md:px-10 lg:px-20'>
        ...
        <div className='md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30px]'>
            ...
            <div className='flex flex-col md:flex-row items-center gap-3 text-white text-sm font-light'>
                <img className='w-28' src={assets.group_profiles} alt="Doctor picture poster" />
        ...
        <div className='md:w-1/2 relative'>
            <img className='w-29/30 md:absolute bottom-0 h-auto rounded-lg' src={assets.header_img} alt="Doctor poster" />
        </div>
